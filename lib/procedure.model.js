...
const PROCEDURE_MODEL_NAME = getString('PROCEDURE_MODEL_NAME', 'Procedure');
const PROCEDURE_COLLECTION_NAME = getString(
  'PROCEDURE_COLLECTION_NAME',
  'procedures'
);
...
ProcedureSchema.methods.preValidate = function preValidate(done) {
  ...
  this.incidentType = this.incidentType || _.get(this, 'activity.incidentType');
