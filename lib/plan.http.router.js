 ...
 * @apiSuccess {Object} [incidentType = undefined] An incident type under which
 ...
 * @apiSuccess {Object} [data.incidentType = undefined] An incident type under
...
router.get(PATH_LIST, function getPlans(request, response, next) {
  ...
  Plan
    .get(options, function onGetPlans(error, results) {
...
router.post(PATH_LIST, function postPlan(request, response, next) {
  ...
  Plan
    .post(body, function onPostPlan(error, created) {
...
router.get(PATH_SINGLE, function getPlan(request, response, next) {
  ...
  Plan
    .getById(options, function onGetPlan(error, found) {
...
router.patch(PATH_SINGLE, function patchPlan(request, response, next) {
  ...
  Plan
    .patch(id, patches, function onPatchPlan(error, patched) {
...
router.put(PATH_SINGLE, function putPlan(request, response, next) {
  ...
  Plan
    .put(id, updates, function onPutPlan(error, updated) {
...
router.delete(PATH_SINGLE, function deletePlan(request, response, next) {
  ...
  Plan
    .del(id, function onDeletePlan(error, deleted) {
