...
const { Feature, ADMIN_LEVEL_NAMES } = require('@codetanzania/emis-feature');
...
_.forEach(ADMIN_LEVEL_NAMES, v => FEATURE_SELECT[v] = 1);
const OPTION_FEATURE_AUTOPOPULATE = ({
  select: { category: 1, type: 1, level: 1, name: 1 },
  maxDepth: POPULATION_MAX_DEPTH
});
